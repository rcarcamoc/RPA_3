...
class VerificaInicioSimilitud:
    ...
    def focus_ris(self):
        """Busca, enfoca y maximiza la ventana del RIS / Vue PACS."""
        try:
            titles = ["Carestream RIS", "Workflow Information Management", "Vue RIS", "Carestream RIS V11", "Carestream Vue PACS"]
            for title in titles:
