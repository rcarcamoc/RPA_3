...
Generated: 2025-12-31T08:14:27.300429
Total Actions: 3
Clicks: 2
Inputs: 0
Selects: 0
...
class WebAutomation:
    ...
    def run(self, start_url: str = None):
        ...
        try:
            ...
            # Action 2: CLICK
            print('[ACTION] CLICK on: 48563417 / Raúl Koch Barbagela')
            element = self.find_element(r"""//td[contains(@class, '__rpa-highlight')]""", r"""table#turbogrid > tbody > tr > td:nth-of-type(2)""", clickable=True)
            if element:
            ...
            # Action 3: CLICK
            print('[ACTION] CLICK on: 48563417 / Raúl Koch Barbagela')
            element = self.find_element(r"""//a[contains(@class, '__rpa-highlight')]""", r"""table#turbogrid > tbody > tr > td:nth-of-type(2) > a""", clickable=True)
            if element:
                self.driver.execute_script('arguments[0].scrollIntoView(true);', element)
                time.sleep(1.0)
                element.click()
